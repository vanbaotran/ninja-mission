      ...
      <div className='chatbox'>
       ...
       <div className='chatbox-header flex-row'>
        ...
        <div className='avatar flex-column'>
          {(myChatBuddy?.profileType ==='recruiter') ? <img onClick={()=>this.getPostInfo()} src={this.props.currentRecruiter?.companyLogo} alt=''/> : <img className='border-blue' onClick={()=>this.props.history.push(`/users/${myChatBuddy._id}/fromchat`)} src={this.props.currentCandidate?.avatar} alt=''/>}
